 ...
 * <p>
 * <b>NOTE:</b> this class assumes the stored integers are doc Ids (hence why
 * it extends {@link DocIdSet}). Therefore its {@link #iterator()} assumes
 * {@link DocIdSetIterator#NO_MORE_DOCS} can be used as sentinel. If you intent
 * to use this value, then make sure it's not used during search flow.
 */
